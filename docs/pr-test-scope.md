...
| `src/modules/conversations/**`, `src/app/api/whatsapp/**`, `src/server/twilio/**`, `src/app/(app)/cockpit/atendimento/**`, `src/app/api/cockpit/conversations/**` exceto `src/app/api/cockpit/conversations/**/quotes/**` | `npm run guardrail:mvp-freeze`, `npm run test:whatsapp`, `npm run lint`, `npm run typecheck` |
...
| `src/modules/fulfillment/freight/**`, `src/modules/fulfillment/shipments/**`, `src/modules/fulfillment/presentation/logistics/**`, `src/modules/orders/**`, `src/modules/shipping/**`, `src/app/api/public/cotacao/**`, `src/app/api/orders/**`, `src/app/api/cockpit/conversations/**/quotes/**` | `npm run guardrail:mvp-freeze`, `npm run test:freight`, `npm run lint`, `npm run typecheck` |
