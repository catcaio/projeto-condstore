...
| `src/modules/conversations/**`, `src/app/api/whatsapp/**`, `src/app/api/webhooks/whatsapp/**`, `src/app/api/webhooks/__tests__/**`, `src/server/twilio/**`, `src/app/(app)/cockpit/atendimento/**`, `src/app/api/cockpit/conversations/**` exceto `src/app/api/cockpit/conversations/**/quotes/**` | `npm run guardrail:mvp-freeze`, `npm run test:whatsapp`, `npm run lint`, `npm run typecheck` |
