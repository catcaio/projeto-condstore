...
| `src/modules/fulfillment/freight/**`, `src/modules/fulfillment/shipments/**`, `src/modules/fulfillment/presentation/logistics/**`, `src/modules/orders/**`, `src/modules/shipping/**`, `src/app/api/orders/**`, `src/app/api/cockpit/conversations/**/quotes/**` | `npm run guardrail:mvp-freeze`, `npm run test:freight`, `npm run lint`, `npm run typecheck` |
