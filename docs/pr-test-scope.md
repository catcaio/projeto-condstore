...
| `src/modules/freight/**`, `src/modules/logistics/**`, `src/modules/logistica/**`, `src/modules/orders/**`, `src/modules/shipping/**`, `src/app/api/public/cotacao/**`, `src/app/api/orders/**`, `src/app/api/cockpit/conversations/**/quotes/**` | `npm run guardrail:mvp-freeze`, `npm run test:freight`, `npm run lint`, `npm run typecheck` |
