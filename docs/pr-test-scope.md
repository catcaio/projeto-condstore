...
| `src/modules/fulfillment/freight/**`, `src/modules/fulfillment/shipments/**`, `src/modules/fulfillment/presentation/logistics/**`, `src/modules/pedidos/**`, `src/app/api/public/cotacao/**`, `src/app/api/orders/**`, `src/app/api/cockpit/conversations/**/quotes/**` | `npm run guardrail:mvp-freeze`, `npm run test:freight`, `npm run lint`, `npm run typecheck` |
