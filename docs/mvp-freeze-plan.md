...
| Pedido e shipment | `src/modules/orders/**`, `src/modules/fulfillment/shipments/**`, `src/modules/fulfillment/presentation/logistics/**`, `src/modules/shipping/**`, `src/app/api/orders/**`, `src/app/(app)/cockpit/orders/**` | Fecha o ciclo quote -> order -> shipment que o produto já opera. |
