...
| Pedido e shipment | `src/modules/pedidos/**`, `src/modules/fulfillment/shipments/**`, `src/modules/fulfillment/presentation/logistics/**`, `src/app/api/orders/**`, `src/app/(app)/cockpit/orders/**` | Fecha o ciclo quote -> order -> shipment que o produto já opera. |
