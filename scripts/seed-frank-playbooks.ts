...
async function main() {
    ...
    const newPlaybooks = [
        ...
        },
        {
            ...
            intent: 'consulta_frete',
            triggerPhrases: ['qual o frete', 'entregam no meu cep', 'quanto é a entrega', 'qual transportadora'],
            relatedEntities: ['cep', 'city', 'state'],
            responseBase: 'Entregamos em todo o Brasil. Para calcular o frete e prazo exatos, preciso que você informe o CEP destino.',
            responseShort: 'Passa o CEP para eu calcular.',
            nextStepSuggestion: 'Solicitar CEP',
            requiresConfirmation: false,
            requiresHumanHandoff: false,
            handoffConditions: '',
