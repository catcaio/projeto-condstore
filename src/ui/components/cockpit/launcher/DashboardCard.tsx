...
export function DashboardCard({ tile }: { tile: CockpitTile }) {
    ...
    const isPlanned = tile.badge?.type === 'new' && tile.badge?.label === 'Em breve';
    ...
    const cardContent = (
        <div
            className={cn(
                ...
                "min-h-[120px]",
                isPlanned
                    ? "border-[hsl(var(--ui-border))] bg-[hsl(var(--ui-surface))] opacity-60 cursor-default"
                    : [
        ...
        >
            ...
            <div
                className={cn(
                    ...
                    isPlanned
                        ? "bg-[hsl(var(--ui-muted))] text-[hsl(var(--ui-text-muted))]"
            ...
            <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                    ...
                    {isPlanned && (
                        <span className="flex-shrink-0 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider rounded-full bg-[hsl(var(--ui-muted))] text-[hsl(var(--ui-text-muted))]">
                            Em breve
                        </span>
                    )}
                </div>
