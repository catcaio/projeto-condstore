...
export function Tile({ tile }: { tile: CockpitTile }) {
    ...
    return (
        ...
        >
            <div
                className={cn(
                    "relative flex items-center justify-center flex-shrink-0 w-16 h-16 sm:w-20 sm:h-20",
            ...
            >
                <IconComponent className="w-8 h-8 sm:w-10 sm:h-10 text-[hsl(var(--ui-accent-blue))] transition-colors duration-200 group-hover:text-[hsl(var(--ui-accent-blue-hover))]" strokeWidth={1.5} />
            ...
            <div className="flex flex-col items-center max-w-full">
                <span className="text-xs sm:text-sm font-medium text-[hsl(var(--ui-text))] leading-tight line-clamp-2">
                    {tile.label}
                </span>
            </div>
        </Link>
