...
import { approveAction } from '@/lib/actions/action-engine';
...
export const POST = async (
    ...
    try {
        const approvedBy = auth.session?.sub ?? 'admin';
        const result = await approveAction(tenantId, actionId, approvedBy);
