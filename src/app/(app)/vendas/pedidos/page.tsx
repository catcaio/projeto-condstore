    ...
    return (
        <main className="p-6 md:p-8 max-w-[900px] mx-auto">
            <div className="flex items-center gap-3 mb-6">
                <FileText className="w-5 h-5 text-[hsl(var(--ui-text-muted))]" />
                <div>
                    <h1 className="text-xl font-bold text-[hsl(var(--ui-text))] tracking-tight">Pedidos</h1>
                    <p className="text-sm text-[hsl(var(--ui-text-muted))]">Gestão de pedidos de venda</p>
                </div>
            </div>
