...
export default function CommandBar() {
    return (
        <header className="sticky top-3 z-30">
            <div className="rounded-[1.25rem] border border-[hsl(var(--cockpit-border))] bg-[hsl(var(--cockpit-surface))]/92 px-3 py-2 shadow-[0_16px_48px_-28px_hsl(var(--ui-shadow)/0.7)] backdrop-blur">
                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                    <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                            <h2 className="truncate text-sm font-semibold text-[hsl(var(--cockpit-text))]">
                                Cockpit
                            </h2>
