...
export default function Error({
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-6">
            <div className="bg-[var(--bg-app)] p-8 rounded-2xl shadow-xl border border-red-100 max-w-md w-full text-center">
                ...
                <div className="space-y-3">
                    ...
                    <button
                        ...
                        className="w-full bg-[var(--bg-app)] text-slate-600 font-medium py-3 px-6 rounded-xl border border-slate-200 hover:bg-slate-50 transition-colors"
                    >
