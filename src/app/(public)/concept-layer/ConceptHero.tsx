...
import { CONCEPT_VARIANT } from '@/config/flags';
import { CONCEPT_VARIANTS } from './variants';
import { trackConceptCtaClick } from './track';
...
export function ConceptHero() {
    const variantData = CONCEPT_VARIANTS[CONCEPT_VARIANT];
    ...
    return (
        <ConceptSection>
            ...
            <div
                ...
                data-cs-variant={CONCEPT_VARIANT}
            >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                    <TrackedLink href="/pricing" passHref trackPage="concept_landing" trackSection="hero" trackElement="hero_primary" legacyBehavior onClick={() => trackConceptCtaClick({ variant: CONCEPT_VARIANT })}>
