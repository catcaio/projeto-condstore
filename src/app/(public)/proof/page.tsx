                    ...
                    <PageContainer>
                        ...
                        <div className="rounded-2xl border border-[hsl(var(--ui-border)/0.3)] bg-[hsl(var(--ui-surface)/0.3)] backdrop-blur-sm overflow-hidden shadow-2xl shadow-[hsl(var(--ui-accent-blue)/0.05)]">
                            ...
                            <div className="p-4 md:p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                                {/* Inbox card */}
                                <SiteCard variant="default" className="p-4 bg-[hsl(var(--ui-surface)/0.4)] border-[hsl(var(--ui-border)/0.3)]">
                                        ...
                                        {[
                                            ...
                                            <div key={item.id} className="p-2.5 rounded-lg bg-[hsl(var(--ui-surface-elevated)/0.3)]">
                                                <div className="flex items-center justify-between">
                                                    <span className="text-[10px] font-mono font-bold text-[hsl(var(--ui-text-subtle))]">{item.id}</span>
                                                    {item.urgente && (
                                                        <SiteBadge variant="warning" className="text-[9px] px-1.5 py-0">Atenção</SiteBadge>
                                                    )}
                                                </div>
                                                <div className="flex items-center justify-between mt-1">
            ...
            <ScrollReveal>
                <PageSection spacing="lg" borderTop id="confianca">
                    <PageContainer>
                        ...
                        <SiteCard variant="default" className="mt-10 bg-[hsl(var(--ui-surface)/0.2)] p-5 md:p-6 flex items-start gap-4">
                            ...
                            {[
                                ...
                                return (
                                    <Link key={item.href} href={item.href} className="group">
                                        <SiteCard variant="interactive" className="p-5 flex flex-col gap-3 h-full">
