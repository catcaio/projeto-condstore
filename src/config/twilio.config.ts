...
export const twilioConfig: TwilioConfig = {
  ...
  phoneNumber: process.env.TWILIO_WHATSAPP_NUMBER || 'whatsapp:+5511999999999',
  ...
  signatureValidationEnabled: process.env.NODE_ENV === 'production'
    ? true
    : process.env.TWILIO_SIGNATURE_VALIDATION_ENABLED !== 'false',
};
